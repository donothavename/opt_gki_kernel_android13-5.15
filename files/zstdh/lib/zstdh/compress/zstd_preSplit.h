...
#ifndef ZSTDH_PRESPLIT_H
#define ZSTDH_PRESPLIT_H

#include <linux/types.h>  /* size_t */

#define ZSTDH_SLIPBLOCK_WORKSPACESIZE 8208
 ...
 * @wkspSize must be at least >= ZSTDH_SLIPBLOCK_WORKSPACESIZE
 * note:
